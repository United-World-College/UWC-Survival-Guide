...
- **Early Action (EA)**: a non-binding early round. The timeline is similar to ED's, but if you're admitted, you don't have to enroll, and you can apply EA to multiple schools at once. For most people, an early batch looks like one ED school plus a few EA schools. One thing to note is that EA also has a special variant — Restrictive / Single-Choice EA (REA / SCEA) — used by schools like Harvard, Yale, Princeton, and Stanford. It isn't binding, but it doesn't let you apply ED/EA to other private schools at the same time.
