...
就以我相对熟悉的两个在很多人看来没有特别强的学校为例：[University of Illinois Chicago](https://en.wikipedia.org/wiki/University_of_Illinois_Chicago) 和 [University of Tennessee, Knoxville](https://en.wikipedia.org/wiki/University_of_Tennessee)，这两个学校都是有巨佬坐镇的，比如 UIC 的 [Philip S. Yu](https://cs.uic.edu/profiles/philip-yu/) 在 data mining 领域深耕四十余年，引用量和 h-index 在全球 CS 学者中都是最最顶尖的一批，而 UTK 的 [Jack Dongarra](https://www.eecs.utk.edu/people/jack-dongarra/) 更是2021年的图灵奖得主，在高性能计算领域堪称泰斗级人物，目前虽已 emeritus 但仍在持续指导学生。这两个学校在 US News 以及 [CSRankings](https://csrankings.org/#/index?all&us) 上的排名可能并不是特别显眼，但在各自的强势领域都有着世界级的研究者。
