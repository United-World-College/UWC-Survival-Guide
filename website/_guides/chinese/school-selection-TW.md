...
但對於將來想要學習 STEM 專業的同學們來說一定要謹慎考慮文理學院，尤其是[前文](#ceiling--demand-framework)所說的 lab-based 方向（對於純數、理論 CS、理論物理這些不依賴 lab 而是依賴 mentorship 的方向反而是文理學院的優勢）。這裡有一個常見的 myth： "頂級文理學院的 placement 不輸最好的研究型大學"。這個說法在 humanities 和 social sciences 裡大致成立，但對 STEM 方向則要打一個問號。原因有兩個：
...
具體到一所大學身上，這種價值觀可以被拆成兩件事：第一是保證自己能夠錄取更多一直在默默努力的普通高中生；第二是保證自己的學術 ceiling 足夠高，讓這些走進來的人有機會能接觸到全世界最頂尖的 researcher 和學術資源。而在這一點上，美國絕大部分的州立旗艦對州內學生都做得很不錯——它們的大體量和高錄取率本身就意味著覆蓋面足夠廣，而前文又已經從 [faculty hiring 的隨機性](#faculty-hiring-的隨機性)和 [federal funding 跟著教授走](#聯邦經費與-overhead)這兩個角度論證過，在這些學校裡，優勢學科的 ceiling 其實和最頂尖的私立旗鼓相當。唯一美中不足的是這些學校的助學金政策沒有像私立學校一樣慷慨。但是事情真的是這樣的嗎？

確實，從單個學生拿到的 financial aid 數額來看，頂尖私立的 package 普遍要慷慨不少。但這裡卻出現了一個微妙的統計錯位：不少頂尖私立包括 LAC 經常會宣傳自己 60% 甚至更高比例的學生都拿到了 financial aid，但一所 LAC 一屆只有 500 人左右，就算極端情況下是給一半的學生都免除全部學費（當然這是不太可能的），那也就覆蓋了 250 個人。但一個公立旗艦系統就算助學金政策沒有那麼 generous，只給 5% 的學生免除全部學費，那覆蓋的人群也會比私立多得多，更何況一個公立旗艦系統的助學金政策本身就比很多人想像中要慷慨——光是 University of California 系統就有超過一半的加州本州學生的 tuition 完全被 financial aid 覆蓋，絕對數算下來是上萬人的數量級。比例衡量的是一個機構內部資源分配的結構，絕對數衡量的才是有多少人真的因為這所學校而走上了不太一樣的人生軌跡。這其實是兩件挺不一樣的事情。不過值得注意的是，這兩年一些州立大學的學費也水漲船高，尤其是對 out-of-state 和國際學生；所以前面提到的這種教育平權上州立大學相較於私立學校的邊際優勢其實也在慢慢縮小。

繞了一圈讓我們回到最初的那個問題——錄取率低到底是不是一件值得驕傲的事情呢？我個人認為，對於一家公司而言它沒什麼問題，因為稀缺性本就是一個商業的 signal；但對於一個有著浪漫理想的非營利高等教育機構而言，它其實應該是反過來的：一所學校錄取了多少人、讓多少人有機會接受全世界最好的教育，可能比它拒絕了多少人更接近 "serving humanity" 這件事本來的含義。
...
在這裡我想對「學校只是平台，成長靠自己」這個概念再多聊幾句。說實話，對平台的誤讀很普遍，在很多領域裡都有出現，我願稱之為「MBA 錯覺」：眾所周知很多成功的企業家都有一個頂尖商學院的 [MBA](https://en.wikipedia.org/wiki/Master_of_Business_Administration) 文憑，問題是並不是所有頂尖商學院的 MBA 畢業生都能成為成功企業家。這是一個統計上的錯位。而在統計錯位之外，「MBA 錯覺」在很多時候甚至還包含了因果倒置：對很多成功企業家而言，頂尖商學院的 MBA 是出於他們成功後鍍金的需要才去讀的，這並不是 arbitrary person 讀了就能自動成為成功的企業家。雖然事實上去了頂尖的商學院確實會有更多機會接觸這些成功企業家，但如果這是 arbitrary person 讀 MBA 的首要目的的話那最後大概率是要大失所望的。
