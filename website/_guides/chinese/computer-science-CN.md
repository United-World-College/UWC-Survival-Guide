...
除了 S&P 500 这些巨头之外，还有几条传统行业 SWE 业务线也很值得一提。其中会计与咨询基本是规模最大的一块。Big 4（[Deloitte](https://en.wikipedia.org/wiki/Deloitte)、[PwC](https://en.wikipedia.org/wiki/PricewaterhouseCoopers)、[EY](https://en.wikipedia.org/wiki/Ernst_%26_Young)、[KPMG](https://en.wikipedia.org/wiki/KPMG)）内部都有相当规模的 engineering org，主要做审计自动化、税务软件以及咨询项目里的 tech delivery；战略咨询里 [McKinsey](https://en.wikipedia.org/wiki/McKinsey_%26_Company)（McKinsey Digital）、[BCG](https://en.wikipedia.org/wiki/Boston_Consulting_Group)（BCG X）、[Bain](https://en.wikipedia.org/wiki/Bain_%26_Company)（Bain Vector）这几年也都在大力扩张自己的 digital arm；而 IT 咨询 / outsourcing 这边的 [Accenture](https://en.wikipedia.org/wiki/Accenture)、[IBM Consulting](https://en.wikipedia.org/wiki/IBM_Consulting)、[Cognizant](https://en.wikipedia.org/wiki/Cognizant)、[Infosys](https://en.wikipedia.org/wiki/Infosys)、[TCS](https://en.wikipedia.org/wiki/Tata_Consultancy_Services) 等更是有数十万人规模的 SWE pool。除此之外 biotech / hospital system（[Vertex](https://en.wikipedia.org/wiki/Vertex_Pharmaceuticals)、[Moderna](https://en.wikipedia.org/wiki/Moderna)、[Biogen](https://en.wikipedia.org/wiki/Biogen)、[Regeneron](https://en.wikipedia.org/wiki/Regeneron_Pharmaceuticals) 这些 biotech 加上 [Mass General Brigham](https://en.wikipedia.org/wiki/Mass_General_Brigham)、[Cleveland Clinic](https://en.wikipedia.org/wiki/Cleveland_Clinic) 这样的大型医院系统）也是一个体量很大的 domain-specific SWE cluster，主要做 clinical data pipeline、电子病历、生信分析这一类工作。上面提到的这几类 SWE 整体的 compensation 和 WLB 大致和 S&P 500 差不多，对想做 generalist 或者有生物 / 医学背景的同学都是不错的方向。
